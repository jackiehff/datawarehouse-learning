...
@MapperScan("com.datafly.generator.business.mapper")
public class DataGeneratorApplication {
    ...
    public static void main(String[] args) {
        ...
        BehaviorLogMockTask behaviorLogMockTask = context.getBean(BehaviorLogMockTask.class);
        behaviorLogMockTask.mainTask();
    }
}
